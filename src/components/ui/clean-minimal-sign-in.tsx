...
import { LogIn, Lock, Mail, Eye, EyeOff, Loader2, ArrowLeft } from "lucide-react";
        ...
        <div className="bg-card border border-border rounded-2xl shadow-xl p-8 space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              {mode === "signin" && "Welcome back! Sign in to access your saved itineraries"}
              {mode === "signup" && "Join TripCraft AI to save and manage your travel plans"}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Password Input - Only show for signin/signup */}
            {mode !== "forgot" && (
              <div className="relative">
                <div className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">
            ...
            {/* Back to Sign In - Only show for forgot mode */}
            {mode === "forgot" && (
              <button
                type="button"
                onClick={() => {
          ...
          {/* Only show these sections for signin/signup */}
          {mode !== "forgot" && (
            <>
              {/* Divider */}
              <div className="relative">
